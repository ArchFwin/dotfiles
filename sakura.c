...
const GdkRGBA monokai_palette[PALETTE_SIZE] = {
	{0.286275,	0.282353,	0.243137,	1},
	{0.976470,	0.149020,	0.447059,	1},
	{0.650980,	0.886274,	0.180392,	1},
	{0.992157,	0.582157,	0.121569,	1},
	{0.4,		0.850980,	0.937255,	1},
	{0.682353,	0.505882,	1,			1},
	{0.631373,	0.938255,	0.894118,	1},
	{0.972549,	0.972549,	0.949019,	1},
	{0.458824,	0.443137,	0.368627,	1},
	{0.988235,	0.360784,	0.580392,	1},
	{0.756863,	0.878431,	0.380392,	1},
	{0.996078,	0.698039,	0.341176,	1},
	{0.552931,	0.901961,	0.968627,	1},
	{0.760784,	0.631373,	1,			1},
	{0.733333,	0.964706,	0.937255,	1},
	{0.972549,	0.972549,	0.941176,	1},
};
...
sakura_set_palette(GtkWidget *widget, void *data)
{
	...
	if (gtk_check_menu_item_get_active(GTK_CHECK_MENU_ITEM(widget))) {
		...
		} else if (strcmp(palette, "solarized_light")==0){
			sakura.palette=solarized_light_palette;	
		} else {
			sakura.palette=monokai_palette;
		}
...
sakura_init()
{
	...
	if (strcmp(cfgtmp, "linux")==0) {
		...
		sakura.palette=solarized_dark_palette;
	} else if (strcmp(cfgtmp, "monokai")==0) {
		sakura.palette=monokai_palette;
	} else {
		sakura.palette=solarized_light_palette;
	}
...
sakura_init_popup()
{
	GtkWidget *item_new_tab, *item_set_name, *item_close_tab, *item_copy,
			  ...
			  *item_palette_solarized_dark, *item_palette_solarized_light, *item_palette_monokai,
	...
	item_palette_monokai=gtk_radio_menu_item_new_with_label_from_widget(GTK_RADIO_MENU_ITEM(item_palette_tango), "Monokai");
	...
	if (strcmp(cfgtmp, "linux")==0) {
		...
		gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(item_palette_monokai), TRUE);
	} else {
	...
	gtk_menu_shell_append(GTK_MENU_SHELL(palette_menu), item_palette_monokai);
	...
	g_signal_connect(G_OBJECT(item_palette_monokai), "activate", G_CALLBACK(sakura_set_palette), "monokai");
